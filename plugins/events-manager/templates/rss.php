...
<rss version="2.0" xmlns:atom="http://www.w3.org/2005/Atom">
	<channel>
		...
		<?php
		$scope_default = get_option('dbem_rss_scope');
		$scope_selected = get_query_var( 'scope', "future" );
		//echo $scope_selected; 
		//echo $scope_default;
if (isset($_GET['scope'])) {
  $scope_selected = $_GET['scope'];
} else {
$scope_selected = $scope_default;
}
		//echo $scope_selected; 
		...
		$args = array_merge(array('scope'=>$scope_selected, 'owner'=>false, 'limit'=>$page_limit, 'page'=>1, 'order'=>get_option('dbem_rss_order'), 'orderby'=>get_option('dbem_rss_orderby')), $args);
