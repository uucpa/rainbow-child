	...
	<channel>
		...
		$count = 0;
               $recurring_title = "";
				...
				$event_start_time = $EM_Event->start()->format('d M Y H:i');
                                if( $event_title == $recurring_title ){
                                ?>      
					<?php echo $event_start_time; ?> <br/>
                                <?php
                                } else {
                                        $recurring_title = $event_title;
                                        if( $count !=0 )
                                        {
                                        ?>
                                                ]]></description>
                                        ...
                                        <item>
                                                ...
                                                <description><![CDATA[<?php echo $description; ?> Date(s): 
					<?php echo $event_start_time; ?><br/> 
                                <?php
                                }
                                $count++;
